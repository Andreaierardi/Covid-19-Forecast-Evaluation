...
%     disp(['Sample up to ', datestr(datenum(sel_sample-[0 0 1]))]);
    ...
    for k=1:numel(forecast_names)
        ...
        for h=1:max_h
            ...
            temp1 = unique(x2mdate(forecast(:,3)));  %temp1 = datenum(info(ind, 4),'dd/mm/yy');
            temp_a = forecast(:,1:4);forecast(:,1:4)=[];
    ...
    load('/Users/marziodecorato/Desktop/Stage/sample_data.mat')
    for h=1:max_h
        w = w0; %+2*h;
...
%         if h==2||h==4
    ...
    'AutoUpdate','off','NumColumns',6);
            ...
            print('-bestfit',['/Users/marziodecorato/Desktop/Stage', at],'-dpdf');
        end
    ...
    for fix =1:2
        ...
        if fix==1
            print('-bestfit',['/Users/marziodecorato/Desktop/Stage',state(1:2),'_wce'],'-dpdf');
        else
            print('-bestfit',['/Users/marziodecorato/Desktop/Stage',state(1:2),'_wpe'],'-dpdf');
        end
